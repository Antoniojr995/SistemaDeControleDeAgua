...
// 🖥️ Endereço do seu servidor backend (seu PC)
const char* serverUrl = "http://192.168.31.176:3000"; // ✅ seu IP correto
...
void enviarLeituras(float c1, float c2) {
  ...
  String payload = "{\"caixa1\": " + String(c1, 2) + ", \"caixa2\": 70.00, \"bomba\": 0}";
...
// 💡 Verifica o estado da bomba no servidor
void checarComandoBomba() {
  ...
  if (httpCode == 200) {
    ...
    // Analisa o valor da bomba retornado pelo backend
